  ...
  return (
    ...
    <nav className='w-[100vw]'>
      ...
      <div className='container-fluid '>
        <div className="row hidden lg:flex lg:items-center lg:justify-between p-3 text-white bg-gradient-to-br from-green-800 to-gray-800">
          <div className="col-6 d-flex items-center">
            <h5 className='fw-bold '>Delhi Public School, Khunti</h5>
            
            
          </div>
          <div className="col-6 d-flex justify-content-end">
            <a href="https://github.com/keshav1499" target="_blank" className="btn shadow text-light fw-bold btn-sm btn-primary ms-2 me-2">Visit My Portfolio</a>
          ...
          <div className="container-fluid ">
            <span className='navbar-brand flex items-center'>
              ...
              <div className=' flex-col justify-center hidden lg:flex'>
                ...
                <span className='small text-gray-500'>Khunti-835210</span>
              </div>
              <span className='lg:hidden block text-sm'>Delhi Public School</span>
            </span>
