...
const Campus = () => {
  ...
  const campusImages = [
    'https://res.cloudinary.com/dmfbnkb1q/image/upload/v1745056356/WhatsApp_Image_2025-03-22_at_20.28.20_49a3f2c4_am73rb.jpg',
    'https://res.cloudinary.com/dmfbnkb1q/image/upload/v1745056356/IMG-20250419-WA0012_dmi74d.jpg',
    'https://res.cloudinary.com/dmfbnkb1q/image/upload/v1745056357/IMG-20250419-WA0014_cjoio5.jpg',
  ...
  const campusVideos = [
    'https://www.youtube.com/embed/Uijwncn70Go',
    'https://www.youtube.com/embed/tshHwxs8rto',
  ];
  ...
  return (
    <div className="bg-green-50 py-16">
      <div className="container mx-auto text-center px-4">
        <section>
          <h2 className="text-3xl lg:text-5xl font-bold mb-8 text-green-700">Campus Showcase</h2>
        ...
        <section className="mb-16">
          <h2 className="text-3xl lg:text-5xl font-bold mb-8 text-green-700">Campus Video Showcase</h2>
